# Edit this configuration file to define what should be installed on your system. Help is available in
# the configuration.nix(5) man page, on https://search.nixos.org/options and in the NixOS manual 
# (`nixos-help`).
...

{
  ...
  # networking.hostName = "nixos"; # Define your hostname. Pick only one of the below networking 
  # options. networking.wireless.enable = true; # Enables wireless support via wpa_supplicant.
  ...
  # Configure keymap in X11 services.xserver.xkb.layout = "us"; services.xserver.xkb.options = 
  ...
  users.users.hiroki = {
    ...
    packages = with pkgs; [ tree gh ];
  };

  # programs.firefox.enable = true;

  # List packages installed in system profile. You can use https://search.nixos.org/ to find more 
  # packages (and options). environment.systemPackages = with pkgs; [
  ...
  # is used to maintain compatibility with application data (e.g. databases) created on older NixOS 
  # versions.
  #
  # Most users should NEVER change this value after the initial install, for any reason, even if 
  # you've upgraded your system to a new NixOS release.
  #
  # This value does NOT affect the Nixpkgs version your packages and OS are pulled from, so changing 
  # it will NOT upgrade your system - see https://nixos.org/manual/nixos/stable/#sec-upgrading for how 
  # to actually do that.
  #
  # This value being lower than the current NixOS release does NOT mean your system is out of date, 
  # out of support, or vulnerable.
  #
